<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="wedeal.bean.BoardDBBean, wedeal.bean.CateDBBean, java.util.ArrayList, wedeal.bean.*"%>
...
<body>
	...
	<%
		ArrayList<LikeDataBean> userlikelist = (ArrayList<LikeDataBean>)request.getAttribute("userlikelist");
		ArrayList<String> boardtitlelist = (ArrayList<String>)request.getAttribute("boardtitlelist");
	%>
	<div class='container'>
		<div class='row'>
			<table class="table table-striped" style="border: 1px solid #dddddd; float:left; width:100%; ">
				...
				<tbody>
					<tr>
						...
						%>
							<td style="baokground-color: #eeeeee; text-align: center; height: 30px;"><%=userlikelist.get(i).getLike_num() %></td>
							<td style="baokground-color: #eeeeee; text-align: center; height: 30px;"><%=boardtitlelist.get(i) %></td>
							<td style="baokground-color: #eeeeee; text-align: center; height: 30px;"><%=userlikelist.get(i).getLike_date() %></td>
						<%
							}
						%>
					</tr>
